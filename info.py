...
DIRECT_GEN_DB = int(environ.get("DIRECT_GEN_DB", "-1001230076027")) # Enter your channel id
DIRECT_GEN_URL = environ.get("DIRECT_GEN_URL", "https://rockersdisc.blogspot.com") # https://example.com/
