...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001292264705'))
...
DIRECT_GEN_URL = environ.get("DIRECT_GEN_URL", "https://rushidhar1999-file-to-link-1-ce3a48ee8b15.herokuapp.com/") # https://example.com/
